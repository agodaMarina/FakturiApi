...
//    public ResponseEntity<String> ajoutFactureManuelle(@RequestBody Facture facture, @RequestPart MultipartFile file) throws IOException {
//
//        factureService.addFacture(facture, file);
