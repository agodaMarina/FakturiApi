...
//
//    @Override
//    public void addFacture(Facture facture, MultipartFile file) throws IOException {
//        User user1=new User();
...
//                row.createCell(1).setCellValue(facture.getDateEmission().toString());
